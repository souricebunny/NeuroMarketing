...
% Author: Ruhani Gill is the SOLE author. The work was carried out under the
% guidance of Dr Misha Kakkar (faculty), who is credited by name below and in
% the Acknowledgements but is NOT a co-author. The four Research Topic editors
% (S.\ Khan, D.\ Mehrotra, S.\ Bhartiya, A.\ Garg) are EDITORS, not co-authors,
% and must NOT appear here.
\author[1,*]{Ruhani Gill}
\affil[1]{Amity University, Noida, Uttar Pradesh, India}
\affil[ ]{Work conducted under the guidance of Dr Misha Kakkar, Amity University, Noida.}
\affil[*]{Correspondence: \texttt{[insert Ruhani Gill's email]}}
...
R.G.\ is the sole author and conceived the study, designed and executed the
computational pipeline, performed the analyses, recovered and prepared the
figures, and wrote the manuscript. The author read and approved the submitted
version. The work was carried out under the academic guidance of Dr Misha
Kakkar.
...
was carried out at Amity University under the guidance of Dr Misha Kakkar.
